		...
		>
			...
			>
				<div className="flex flex-col items-center mb-4">
					<div
						className={`flex items-center justify-center w-12 h-12 rounded-full mb-2 transition-colors duration-300 ${
					...
					<h1
						className={`text-lg font-bold mb-1 text-center transition-colors duration-300 ${
					...
					>
						Please make sure you have entered your UPI ID and Name correctly.
						Both fields are required to generate a QR code.
					</p>
				</div>
