...
export default function BlockFalse() {
  const { formData, errors, isLoading, updateField, submitForm } = useUPIForm();
  ...
  const errorMsg =
    ...
    errors.amount ||
    errors.note ||
    (errors.upiId === "UPI ID is required" ? errors.upiId : "");
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center min-h-[60vh] w-full transition-colors duration-300 ${
        isDark
    ...
    >
      <div
        className={`w-full max-w-md rounded-2xl shadow-xl p-6 sm:p-8 flex flex-col items-center transition-colors duration-300 ${
          isDark
      ...
      >
        <div className="flex flex-col items-center mb-4">
          <h1 className="text-xl font-extrabold bg-linear-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent mb-1 tracking-tight">
            Create UPI QR Code
          </h1>
          <p
            className={`text-sm font-medium text-center max-w-xs transition-colors duration-300 ${
        ...
        >
          ...
          <div className="text-center mt-4">
            ...
            {errorMsg && (
              <div
                className={`mt-3 p-3 border text-sm font-medium rounded-xl shadow-sm transition-colors duration-300 ${
                  isDark
