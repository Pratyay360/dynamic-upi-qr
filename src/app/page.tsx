...
function LoadingFallback() {
  ...
  return (
    <div
      className={`container px-5 py-24 mx-auto text-center transition-colors duration-300 ${
        isDark ? "bg-gray-900" : "bg-gray-50"
      }`}
    >
      <div
        className={`qr-container items-center justify-center p-8 rounded-2xl transition-colors duration-300 ${
...
function EducationalDisclaimer() {
  ...
  return (
    <div
      className={`educational-disclaimer fixed bottom-0 left-0 right-0 z-50 py-3 px-4 text-center backdrop-blur-md border-t transition-colors duration-300 ${
